...
<?php
//$PageTitle = "Home";
$Breadcrumb = "<li><a href=''>SummaryStatistics</a></li>
<li class='active'>SummaryStatistics</li>";
$PageLeftHeader = "";
    ...
    <div class="col-lg-12">
        ...
        <form action="SummaryStatistics/Export" method="post" class="pull-right" style="margin-left: 10px" id="ExportForm">
            ...
            <div class="form-group mr20">
                <button class="btn btn-success" style="vertical-align: top" id="GetData">Export</button>
            </div>
        </form>
...
<script type="text/javascript">
    ...
    $("#chartMonth").click(function(){
        ...
        $('#summaryreport-list').trigger('refreshGrid', {
            duration:"Monthly"
        });
        $("#interval").val("Monthly");
    })

    $("#chartYearly").click(function(){
    ...
    $("#GetData").click(function () {
        ...
        $("#DateFrom").val($("#dateFrom").val().split(' ')[0]);
        $("#DateTo").val($("#dateTo").val().split(' ')[0]);
    ...
    $(document).ready(function(){
       $("#chartToday").trigger("click");
    });

    $(".dateOpt").click(function(){
        $.ajax({
            url:'<?php echo BASE_URL ?>SummaryStatistics/GetAll?opt='+$(this).val(),
