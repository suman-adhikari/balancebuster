...
gulp.task('concat', function () {
    gulp.src('BalanceBuster/includes/scripts/*.js') // path to your files
    .pipe(concat('concat.js'))  // concat and name it "concat.js"
    .pipe(gulp.dest('BalanceBuster/includes/scripts/'));
});

*/

gulp.task('concat', function() {
  return gulp.src('./includes/scripts/*.js')
    .pipe(concat('all.js'))
    .pipe(gulp.dest('./includes/scripts'));
});

gulp.task('sass', function(){
  return gulp.src('./includes/styles/*.scss')
    .pipe(sass()) // Using gulp-sass
    .pipe(gulp.dest('./includes/scss'))
});
